...
class Migration_Oauth_league_20140521035103 extends Minion_Migration_Base {
	...
	{
		$db->query(NULL, "CREATE TABLE `oauth_clients` (
		  `id` CHAR(40) NOT NULL,
		...
		$db->query(NULL, "CREATE TABLE `oauth_client_endpoints` (
		...
		$db->query(NULL, "CREATE TABLE `oauth_sessions` (
		  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
		  `client_id` char(40) NOT NULL,
		...
		$db->query(NULL, "CREATE TABLE `oauth_session_access_tokens` (
		  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
		...
		$db->query(NULL, "CREATE TABLE `oauth_session_authcodes` (
		  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
		  `session_id` int(10) unsigned NOT NULL,
		...
		$db->query(NULL, "CREATE TABLE `oauth_session_redirects` (
		  `session_id` int(10) unsigned NOT NULL,
		  `redirect_uri` varchar(255) NOT NULL,
		...
		$db->query(NULL, "CREATE TABLE `oauth_session_refresh_tokens` (
		...
		$db->query(NULL, "CREATE TABLE `oauth_scopes` (
		...
		$db->query(NULL, "CREATE TABLE `oauth_session_token_scopes` (
		...
		$db->query(NULL, "CREATE TABLE `oauth_session_authcode_scopes` (
